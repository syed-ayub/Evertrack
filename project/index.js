const keepersContractAddress = "0x882768eC0503D77f4db57Cf630920c21D59B59De"
...
async function connectMetaMask (){
    ...
    if(typeof window.ethereum !== "undefined"){
		...
		var gradtext=document.getElementById("gradboxtext");
                gradtext.innerHTML=accounts;
				// gradboxtext
    }
    else {
...
async function callContract() {
			...
			async function Revokee() {
                let a = document.getElementById("RRole").value;
                let b = document.getElementById("aaddressTo").value;
                ...
                const counter = await keepersContract.revokeRole(a,b);
